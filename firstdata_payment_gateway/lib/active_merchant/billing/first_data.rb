...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    ...
    # :pem                  The text of your FirstData PEM file. Note
    ...
    #
    # 
    # FirstData's Items entity is an optional entity that can be attached to orders.
    ...
    class FirstDataGateway < Gateway     
      # Your global PEM file. This will be assigned to you by FirstData
      # 
      # Example: 
      # 
      ...
      def initialize(options = {})
        ...
        @options = {
          :result => 'LIVE',
          :pem => FirstDataGateway.pem_file
        }.update(options)
        
        raise ArgumentError, "You need to pass in your pem file using the :pem parameter or set it globally using ActiveMerchant::Billing::FirstDataGateway.pem_file = File.read( File.dirname(__FILE__) + '/../mycert.pem' ) or similar" if @options[:pem].blank?
      end
